 ...
 * <p>
 *  This is the Helper class to read data from excel (xlsx) file(s). It has different general purpose overloaded methods to make reading simpler.
...
public class Xlsx_Reader {
	...
	/*	public static void main(String arg[]) throws IOException{
		...
		datatable = new Xls_Reader("D:\\Controller.xlsx");
